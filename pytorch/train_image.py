...
if __name__ == "__main__":
    ...
    parser.add_argument('--s_dset_path', type=str,
                        default='/home/tuo/jhu/PADA-master/pytorch/data/office/dslr_31_list.txt',
                        help="The source dataset path list")
    parser.add_argument('--t_dset_path', type=str,
                        default='/home/tuo/jhu/PADA-master/pytorch/data/office/amazon_31_list.txt',
    ...
    if config["dataset"] == "office":
        if ("amazon" in args.s_dset_path and "webcam" in args.t_dset_path) or \
            ...
            config["optimizer"]["lr_param"][
                "lr"] = 0.001  # optimal parameters
        elif ("amazon" in args.s_dset_path and "dslr" in args.t_dset_path) or \
                ("dslr" in args.s_dset_path and "webcam" in args.t_dset_path):
            config["optimizer"]["lr_param"][
                "lr"] = 0.0003  # optimal parameters
